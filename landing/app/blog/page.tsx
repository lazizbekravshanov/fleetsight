...
export const metadata: Metadata = {
  ...
  description:
    "Articles on chameleon carrier detection, FMCSA BASIC scores, carrier vetting, fraud red flags, and freight safety intelligence. Stay informed with FleetSight.",
  openGraph: {
    title: "FleetSight Blog — Carrier Verification & Freight Safety",
    description:
      "Expert guides on chameleon carrier detection, FMCSA compliance, carrier vetting, and fraud red flags for brokers and safety teams.",
    type: "website",
  },
};
...
const posts = [
  {
    slug: "how-to-vet-a-carrier",
    title: "How to Vet a Carrier: A Step-by-Step Playbook for Brokers and Shippers",
    description:
  ...
  {
    slug: "carrier-packet-checklist-2026",
    title: "Carrier Packet Checklist 2026: Everything You Need on File",
    description:
      "The 2026 carrier packet checklist — every document, certificate, and verification step required to onboard a new carrier without compliance gaps.",
    date: "2026-04-06",
    tag: "Onboarding",
  },
  {
    slug: "carrier-fraud-red-flags",
    title: "Carrier Fraud Red Flags: 12 Warning Signs Every Broker Should Know",
    description:
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Guides on carrier verification, chameleon detection, FMCSA
          compliance, fraud red flags, and freight safety intelligence.
        </p>
      </section>
